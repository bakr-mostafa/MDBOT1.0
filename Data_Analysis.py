...
def analysis():
        ...
        with open("Scraped-Data/dataset_uncleaned.csv", encoding="utf8", errors='ignore') as csvfile:
        ...
        with open("Scraped-Data/dataset_clean.csv","w", encoding="utf8", errors='ignore') as csvfile:
        ...
        slist = []
        dlist = []
        with open("Scraped-Data/nodetable.csv","w", encoding="utf8", errors='ignore') as csvfile:
            writer = csv.writer(csvfile)
